...
module tb_decimation_filter;
    ...
    initial begin
        ...
        input_file = $fopen("sim/test_files/modulator_output1.txt", "r");
        if (input_file == 0) begin
            $display("ERROR: Could not open input txt file");
            $finish;
        end

        output_file = $fopen("sim/test_files/output_filters.txt", "w");
    ...
    initial begin
        $dumpfile("sim/waveforms/wave_decimation_filter.vcd");
